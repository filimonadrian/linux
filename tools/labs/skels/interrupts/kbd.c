...
static int kbd_init(void)
{
	...
	if (!request_region(I8042_DATA_REG, MY_NR_PORTS, MODULE_NAME)) {
     		/* handle error */
     		return -ENODEV;
	}

	if (!request_region(I8042_STATUS_REG, MY_NR_PORTS, MODULE_NAME)) {
     		/* handle error */
     		return -ENODEV;
	}
